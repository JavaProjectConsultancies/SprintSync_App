        ...
        <CardContent>
          <div className="space-y-4">
            {accessibleProjects.slice(0, 3).map((project) => (
              <div key={project.id} className="flex items-center justify-between p-4 rounded-lg border bg-gradient-to-r from-white to-gray-50/50">
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {hasPermission('manage_projects') && (
              <Button className="h-auto p-4 flex flex-col items-center space-y-2 bg-white hover:bg-gray-50 text-foreground border shadow-sm">
