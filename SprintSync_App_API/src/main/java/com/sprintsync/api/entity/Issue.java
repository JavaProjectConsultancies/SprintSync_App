...
/**
 * Issue entity representing issues in the SprintSync application.
 * Maps to the 'issues' table in the database.
 * Similar to Task but without template functionality.
 * 
