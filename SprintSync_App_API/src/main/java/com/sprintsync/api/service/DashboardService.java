...
public class DashboardService {
    ...
    public Map<String, Object> getDashboardStatistics() {
        ...
        // Active counts
        statistics.put("activeProjects",
                projectRepository.countByStatus(com.sprintsync.api.entity.enums.ProjectStatus.ACTIVE));
        statistics.put("activeSprints",
                sprintRepository.countByStatus(com.sprintsync.api.entity.enums.SprintStatus.ACTIVE));

        // Completed counts
        statistics.put("completedSprints",
                sprintRepository.countByStatus(com.sprintsync.api.entity.enums.SprintStatus.COMPLETED));
        statistics.put("completedStories",
                storyRepository.countByStatus(com.sprintsync.api.entity.enums.StoryStatus.DONE));
        ...
        statistics.put("overdueTasks",
                taskRepository.countOverdueTasks(LocalDate.now(), com.sprintsync.api.entity.enums.TaskStatus.DONE));
     ...
     */
    @Cacheable(cacheNames = "shortLivedCacheManager", key = "'projectStats:' + #projectId")
    ...
    public Map<String, Object> getUserDashboardStatistics(String userId) {
        ...
        statistics.put("completedTasks",
                taskRepository.countByAssigneeIdAndStatus(userId, com.sprintsync.api.entity.enums.TaskStatus.DONE));
        statistics.put("completedSubtasks", subtaskRepository.countByAssigneeIdAndIsCompleted(userId, true));
        statistics.put("completedStories",
                storyRepository.countByAssigneeIdAndStatus(userId, com.sprintsync.api.entity.enums.StoryStatus.DONE));
     ...
     */
    @Cacheable(cacheNames = "shortLivedCacheManager", key = "'projectRecent:' + #projectId")
    public Map<String, Object> getProjectRecentActivities(String projectId) {
        ...
        LocalDateTime since = LocalDateTime.now().minusDays(7);
        List<Story> recentStories = storyRepository.findTop10ByProjectIdAndUpdatedAtAfterOrderByUpdatedAtDesc(projectId,
                since);
        activities.put("recentStories", recentStories);
    ...
    public Map<String, Object> getUserRecentActivities(String userId) {
        ...
        LocalDateTime since = LocalDateTime.now().minusDays(7);
        List<Task> recentTasks = taskRepository.findTop10ByAssigneeIdAndUpdatedAtAfterOrderByUpdatedAtDesc(userId,
                since);
        activities.put("recentTasks", recentTasks);

        // Recent subtasks assigned to user
        List<Subtask> recentSubtasks = subtaskRepository
                .findTop10ByAssigneeIdAndUpdatedAtAfterOrderByUpdatedAtDesc(userId, since);
    ...
    public Map<String, Object> getSprintProgressOverview() {
        ...
        List<Sprint> planningSprints = sprintRepository
                .findByStatus(com.sprintsync.api.entity.enums.SprintStatus.PLANNING);
        ...
        // Note: Sprint entity doesn't have completionPercentage field in current
        // database schema
     ...
     */
    @Cacheable(cacheNames = "shortLivedCacheManager", key = "'projectSprintProgress:' + #projectId")
     ...
     */
    @Cacheable(cacheNames = "shortLivedCacheManager", key = "'projectTeamPerformance:' + #projectId")
    public Map<String, Object> getProjectTeamPerformance(String projectId) {
        ...
        long completedProjectTasks = projectTasks.stream()
                ...
                .count();
        double projectTaskCompletionRate = !projectTasks.isEmpty()
                ? (double) completedProjectTasks / projectTasks.size() * 100
                : 0.0;
     ...
     */
    @Cacheable(cacheNames = "shortLivedCacheManager", key = "'projectVelocity:' + #projectId")
    ...
    public Map<String, Object> getTaskDistribution() {
        ...
        Map<com.sprintsync.api.entity.enums.TaskStatus, Long> statusDistribution = new EnumMap<>(
                com.sprintsync.api.entity.enums.TaskStatus.class);
     ...
     */
    @Cacheable(cacheNames = "shortLivedCacheManager", key = "'projectTaskDist:' + #projectId")
     ...
     */
    @Cacheable(cacheNames = "shortLivedCacheManager", key = "'projectPriorityDist:' + #projectId")
     ...
     */
    @Cacheable(cacheNames = "shortLivedCacheManager", key = "'projectOverdue:' + #projectId")
    public Map<String, Object> getProjectOverdueItems(String projectId) {
        ...
        List<Subtask> projectOverdueSubtasks = Collections.emptyList(); // Note: Subtask entity doesn't have projectId
                                                                        // field
     ...
     */
    @Cacheable(cacheNames = "shortLivedCacheManager", key = "'projectUpcomingDeadlines:' + #projectId")
     ...
     */
    @Cacheable(cacheNames = "shortLivedCacheManager", key = "'projectTeamAllocation:' + #projectId")
    ...
    public Map<String, Object> getProjectHealthMetrics() {
        ...
        List<Map<String, Object>> projectHealths = allProjects.stream()
                .map(project -> {
                    ...
                    double overduePercentage = !projectTasks.isEmpty()
                            ? (double) overdueTasks / projectTasks.size() * 100
                            : 0;
     ...
     */
    @Cacheable(cacheNames = "shortLivedCacheManager", key = "'projectHealth:' + #projectId")
    ...
    public Map<String, Object> getDateRangeStatistics(LocalDate startDate, LocalDate endDate) {
        ...
        long tasksCompleted = taskRepository.countByCreatedAtBetweenAndStatus(startDateTime, endDateTime,
                com.sprintsync.api.entity.enums.TaskStatus.DONE);
        ...
        long storiesCompleted = storyRepository.countByCreatedAtBetweenAndStatus(startDateTime, endDateTime,
                com.sprintsync.api.entity.enums.StoryStatus.DONE);
     ...
     */
    @Cacheable(cacheNames = "shortLivedCacheManager", key = "'projectDateRange:' + #projectId + ':' + #startDate + ':' + #endDate")
