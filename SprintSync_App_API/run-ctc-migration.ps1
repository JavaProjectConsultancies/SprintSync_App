# PowerShell script to run the CTC migration
# This script executes the SQL migration to add the ctc column to the users table
...
$sqlFile = "src\main\resources\db\migration\add_ctc_to_users.sql"
$sqlContent = Get-Content $sqlFile -Raw

Write-Host "Running CTC migration..."
...
if ($psqlPath) {
    ...
    Write-Host "psql not found. Please install PostgreSQL client tools or run the SQL manually."
    Write-Host ""
